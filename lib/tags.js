...
exports.parse = function (args, defaults, replacements) {
    ...
    var map_keyword = function (keyword, value) {
            options[keyword] = (value === undefined) ? true : value;
        };

    var map_singles = function (singles, value) {
    ...
    var map_integers = function (string) {
            if (/^[0-9]+$/.test(string)) {
    ...
    var extract_assignment = function (assignment, map_function) {
